...
const AdminDashboard = () => {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-r from-[#FFD42A] to-[#FFC107] p-4 sm:p-8">
    <div className="max-w-6xl mx-auto bg-white/90 backdrop-blur-xl 
    rounded-3xl shadow-2xl p-4 sm:p-8">

      <h1 className="text-2xl sm:text-4xl font-extrabold mb-6 sm:mb-8 text-center
      ...
      <div className="md:hidden space-y-4">
        {users.map((u) => (
          ...
          >
            ...
            <p className="text-sm mb-3">Class: {u.className}</p>
